                        ...
                        <table class="shop_table cart">
                                ...
                                <tr class="cart_item">
                                    ...
                                    <td class="product-thumbnail">
                                        ...
                                        <div class="cart-product__item">
                                            <a href="#">
                                                <img src="{{ $product->model->image1 }}" style="width:128px;height:100px;" alt="product" class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                            </a>
                            ...
                            <tr>
                                <td colspan="5" class="actions">
                                    ...
                                    <a href="{{ route('product') }}"><div class="btn btn-medium btn--dark btn-hover-shadow">
